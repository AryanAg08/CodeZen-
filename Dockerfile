...
#    docker run -d --name code-editor-web -p 9010:80 AryanAg/code-editor-web
#
#    Run image as virtual host (read more: https://github.com/nginx-proxy/nginx-proxy):
#    docker run -e VIRTUAL_HOST=code-editor-web --name code-editor-web AryanAg/code-editor-web
